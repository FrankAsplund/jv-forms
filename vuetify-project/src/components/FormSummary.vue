<template>
    <v-form>
      ...
      <div class="summary-info">
        <div class="text-body-2">
          ...
          <br />
          Du kan hoppa till valfritt avsnitt genom att klicka på önskad sida i listan ovan. Ändra uppgift och klicka sedan på denna sida i
          listan igen
        </div>
      </div>
      ...
      <div class="flex-container">
        <div class="flex-child">
          ...
          <v-table density="compact">
            <thead>
              ...
              <tr>
                ...
                <th class="text-right">{{ formData.applicant_personal_number }}</th>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <th class="text-right">{{ formData.applicant_customer_number }}</th>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <th class="text-right">{{ formData.applicant_county_name.name }}</th>
              </tr>
              <tr>
          ...
          <div class="summary-btn">
            <v-btn @click="stepBack_personal_info_form" color="success">Ändra uppgifter</v-btn>
          </div>
        </div>
        ...
        <div class="flex-child">
          ...
          <v-table density="compact">
            ...
            <div class="summary-btn">
              <v-btn @click="stepBack_application_form" color="success">Ändra uppgifter</v-btn>
            </div>
          </v-table>
        </div>
      </div>
            ...
            <div>
              ...
              <v-list>
                ...
                <v-list-item prepend-icon="mdi:mdi-circle-small">
                  Jag är införstådd med och uppfyller de villkor som finns för att få ta del av stödet.
                </v-list-item>
                <v-list-item prepend-icon="mdi:mdi-circle-small">
                  Ansökan inte gäller ett företag i ekonomiska svårigheter enligt art. 2.14 i förordningen (EU) nr 702/2014
                </v-list-item>
              </v-list>
            </div>
          </template>
  ...
  const emit = defineEmits(['submit-all', 'update:modelValue', 'update:stepProp']);
