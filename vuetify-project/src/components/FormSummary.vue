                ...
                <v-table density="compact">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right">
                                {{ formDataApply.productionType ? "Ja" : "Nej" }}
                            </th>
                        </tr>
                        <tr>
                            <th class="text-left">Jag söker krisstöd för areal</th>
                            <th class="text-right">
                                {{ formDataApply.areal ? "Ja" : "Nej" }}
                            </th>
                        </tr>
                    </thead>
                </v-table>
                ...
                <template v-slot:label>
                    <div>
                        ...
                        <v-list>Jag intygar att: <br />
                            <v-list-item prepend-icon="mdi-circle-small">Jag är införstådd med och uppfyller de villkor som
                                finns för
                                att få ta del av stödet.</v-list-item>
                            <v-list-item prepend-icon="mdi-circle-small">Ansökan inte gäller ett företag i ekonomiska
                                svårigheter enligt
                                art. 2.14 i förordningen (EU) nr 702/2014</v-list-item>
                        </v-list>
                    </div>
                </template>
            </v-checkbox>
